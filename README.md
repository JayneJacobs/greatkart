...
##
[Made with ❤️ and Python](https://rathank.com/deploy-django-greatkart-project-on-amazon-aws-elastic-beanstalk/)

rathank.com/deploy-greatkart

source ~/.bash_profi~~l~~e
pip install -r requirements.txt --upgrade
deactiveate to restore base environment
...
eb status
  CNAME: django-greatkart-env.eba-8siujf82.us-west-2.elasticbeanstalk.com
